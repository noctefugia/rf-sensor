...
Система состоит из двух частей: автономного сенсорного модуля на аккумуляторе и USB-приемника, который подключается к ПК для сбора и визуализации данных в реальном времени.
...
### 1. Проектирование электроники (Hardware Design)

Схемы и многослойные печатные платы были спроектированы в среде **EasyEDA**. Особое внимание уделялось миниатюризации и разделению аналоговых и цифровых цепей для снижения помех.
...
### 4. Программное обеспечение для ПК (PC Application)
